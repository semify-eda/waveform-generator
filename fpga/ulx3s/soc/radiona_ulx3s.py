...
_io_common = [
    ...
    # J2
    ("J2_27n", 0, Pins("E13"), IOStandard("LVCMOS33")),
    ("J2_27p", 0, Pins("D13"), IOStandard("LVCMOS33")),
    ("J2_26n", 0, Pins("C13"), IOStandard("LVCMOS33")),
    ("J2_26p", 0, Pins("B13"), IOStandard("LVCMOS33")),
    
    ("J1_13n", 0, Pins("G5"), IOStandard("LVCMOS33")),
    ("J1_13p", 0, Pins("H4"), IOStandard("LVCMOS33")),
